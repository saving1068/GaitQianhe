<template>
	<div>
		...
		<div class="domestic" v-if="index == 0">
			<div class="hot" style="-webkit-overflow-scrolling: touch;" :style="{'height':windowHeight}">
...
<script>
	...
	export default {
		...
		data() {
			return {
				windowHeight:window.screen.height-44+"px",
				seach_value: "",
				index: 0,
				shuIndex: -1,
				shuIndexTwo:0,
...
//						},"province")
		...
		beforeRouteLeave(to, from, next) {
			...
			}else if(to.name=="Home"&&!this.searchFlag){
         console.log(to)
        let query={...this.$route.query}
				...
				to.query.province = this.province;
				if(this.cityName){
					to.query.cityName = this.cityName;
				}
				to.query.time = this.time;
				to.query.cityId = this.cityId;
				to.query.regionId = this.cityId? this.cityId:this.$route.query.regionId;
			}
