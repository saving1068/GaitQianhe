  ...
  & > .loading {
    ...
    @keyframes  icon{
      ...
      &.ball-beat > .icon{
       	...
       	top: 0.05rem;
       	transition: 0.5s;
       	animation: icon 0.7s 0s  infinite linear;
       }
        &.ball-beat > .text{
        	font-size: 0.28rem;
        	margin-left: 0.08rem;
        ...
        component.img-inner-box(
          ...
          :style="{width:'3.4rem'}"
           ...
           component.img-wraper(
            ...
            :style="{width:'3.4rem',height:'2.4rem'}")
             img(
                :src="v[srcKey]"
...
//      }
    ...
    waterfall() {
      ...
      let obj={
      	index:this.index,
      	colsHeightArr:this.colsHeightArr
      }

    this.$emit('getHeight',obj)
